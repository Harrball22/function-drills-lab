...
colorRating = faveColorFinder("yellow")
...
const bestMovie = (movie) => `${movie} is the beset movie ever!`
...
console.log(emailCheck("owosiifj@soin   "))
...
function chocolateBuyer(gold){
  let frogsBought = gold / 3
  return frogsBought
}

let totalFrogs = chocolateBuyer(100)
...
function chocolateBuyer2(gold){
  let frogsBought = gold / 3
  frogsBought = Math.floor(frogsBought)
  return frogsBought
}

let totalFrogs2 = chocolateBuyer2(100)
